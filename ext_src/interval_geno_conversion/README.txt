...
These files contain the INTERVAL imputed genotype data in plink version 2's binary 
...
I've also assigned variants without rsIDs unique identifiers of the format
CHROM:POS:ALT:REF. In the BGEN files these all have "." as an identifier,
which causes numerous problems for downstream analysis with plink.
