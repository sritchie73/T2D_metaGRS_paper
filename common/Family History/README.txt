...
As with the other curated datasets, rows in each file are uniquely identifiable
by eid and visit_index, where eid corresponds to the unique identifier for the 
participant specific to this UK Biobank application, and visit_index corresponds
to the assessment visit that the survey responses in the respective row were
collected at (0 = Baseline Assessment, 1 = First repeat assessment, 
2 = First imaging assessment, 3 = Second imaging assessment").